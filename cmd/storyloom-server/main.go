...
func main() {
	...
	api := operations.NewStoryloomAPI(swaggerSpec)
	server := restapi.NewServer(api)
	server.ConfigureFlags() // inject API-specific custom flags. Must be called before args parsing

	parser := flags.NewParser(server, flags.Default)
	parser.ShortDescription = "StoryLoom API"
	parser.LongDescription = "API for the StoryLoom SaaS Platform, supporting world-building, character tracking, and plot structuring."
